...
Background::Background(): bgSrcTutorial({0,0,384,480}),swamp1Src({0,0,1024,768}),swamp1aSrc({ 0,0,1024,768 }),swamp1bSrc({ 0,0,1024,768 }), swamp1bdownSrc({ 0,0,1024,768 }), gameOverScreenSrc({0, 0, 1024, 768})
{
