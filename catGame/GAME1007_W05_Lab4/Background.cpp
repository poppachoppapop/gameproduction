...
Level1Background::Level1Background(int bg, int length): swamp1Src({ 0,0,1024,768 }), swamp1aSrc({ 0,0,1024,768 }), swamp1bSrc({ 0,0,1024,768 }), swamp1bdownSrc({ 0,0,1024,768 })
{
